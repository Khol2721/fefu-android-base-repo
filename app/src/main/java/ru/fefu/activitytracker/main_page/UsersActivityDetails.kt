...
import ru.fefu.activitytracker.databinding.ActivityUsersDetailsFragmentBinding

class UsersActivityDetails(details: ListItem.Item) :
    BaseFragment<ActivityUsersDetailsFragmentBinding>(R.layout.activity_users_details_fragment) {
    private var _binding: ActivityUsersDetailsFragmentBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = ActivityUsersDetailsFragmentBinding.inflate(inflater, container, false)
        return binding.root     }
}